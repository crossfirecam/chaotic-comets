...
// Original author: Eric Haines (Eric5h5) http://wiki.unity3d.com/index.php?title=AspectRatioEnforcer
...
public class AspectUtility : MonoBehaviour
{
	...
	private void Update()
    {
		if (Time.frameCount % 10 == 0)
		{
			...
			{
				SetCamera();
				res.x = Screen.width; res.y = Screen.height;
				print("Camera changed to: " + res);
			}
		}
    }
