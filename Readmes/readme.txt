...
Source code: https://github.com/crossfirecam/ChaoticCometsGame
...
- If a controller's sticks are experiencing drift, visit 'Options > Rebind Controls > Calibrate'
- If using a Nintendo Switch Pro Controller, it will not work over USB - you must use the Bluetooth mode to use it
